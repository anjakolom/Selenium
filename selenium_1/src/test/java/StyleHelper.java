...
public class StyleHelper {
    ...
    public Float getSize(WebDriver driver, String cssPrice) {
        String fontSize = driver.findElement(By.cssSelector(cssPrice)).getCssValue("font-size").trim();
        int i = fontSize.indexOf("p");
        String str = fontSize.substring(0, i);
